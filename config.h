...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define SIRIUS_MEGAv5_OSD //  Paris_Sirius�꽓 ITG3050,BMA280,MS5611,HMC5883,uBlox  http://www.Multiwiicopter.com <- confirmed by Alex
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       389 // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     43 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 38 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2  37 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT   35 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
